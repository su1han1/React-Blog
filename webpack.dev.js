...
module.exports = {
    ...
    plugins: [
        ...
        new webpack.optimize.AggressiveMergingPlugin(),//improve chunk transfer
        new webpack.HotModuleReplacementPlugin(),
        new webpack.DefinePlugin({
            "progress.env.NODE_ENV": JSON.stringify('development')
        }),
        new HtmlWebpackPlugin({
            title: "Hanning's Blog",
            showErrors: true,
        }),
        new webpack.NoEmitOnErrorsPlugin(),//ensure the page won't be blocked when error(s) happened, and notice error(s) after compile.
        new webpack.HashedModuleIdsPlugin(),//using HashedModuleIdsPlugin to realize chunkhash stability
